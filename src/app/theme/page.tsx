  ...
  return (
    <div className="w-full">
      <div className="w-full flex flex-col gap-10 sm:gap-12">
        ...
        {/* Active Article Section - Direct HTML */}
        <div className="w-full">
          {htmlContent ? (
        ...
        <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-8 pb-12 pt-8 border-t border-[#EDEDED] flex flex-col gap-6">
            ...
            {paginatedContents.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-5 transition-colors ${isSelected
                ...
                >
                  <div className="flex items-center gap-3.5 flex-1 min-w-0">
                    <span
                      className={`px-2.5 py-0.5 rounded text-xs font-bold uppercase shrink-0 ${isSelected
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-2 pt-2">
              <Link
                ...
                className={`h-9 px-3.5 rounded-lg border text-xs font-medium flex items-center justify-center transition-colors ${currentPage === 1
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
                <Link
                  ...
                  className={`w-9 h-9 rounded-lg border text-xs font-bold flex items-center justify-center transition-colors ${p === currentPage
              ...
              <Link
                ...
                className={`h-9 px-3.5 rounded-lg border text-xs font-medium flex items-center justify-center transition-colors ${currentPage === totalPages
                  ? "border-[#EDEDED] text-[#D4D4D4] pointer-events-none"
                  : "border-[#D4D4D4] text-[#282828] hover:border-[#0F3E17] hover:text-[#0F3E17] bg-white"
                  }`}
              >
