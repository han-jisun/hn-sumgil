  ...
  return (
    <div>
      ...
      <section className="relative flex flex-col justify-center items-center text-center min-h-[80vh] py-20 px-6 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(14,165,233,0.08)_0%,transparent_70%)] -z-10 pointer-events-none blur-[40px]"></div>
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          <Link href="/explore" className="inline-flex items-center gap-2 bg-gradient-to-br from-primary to-[#0284c7] text-white py-3.5 px-7 rounded-full font-semibold text-base shadow-[0_4px_20px_rgba(14,165,233,0.3)] hover:-translate-y-0.5 hover:shadow-[0_6px_24px_rgba(14,165,233,0.5)] transition-all duration-300">
            길 탐색하기
      ...
      {/* Featured Section */}
      <section id="featured" className="py-20 bg-gradient-to-b from-transparent to-[rgba(14,165,233,0.02)]">
        <div className="container m-auto">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(360px,1fr))] gap-8 max-[480px]:grid-cols-1">
            {featuredTrails.map((trail) => (
              <Link href={`/explore/${trail.id}`} key={trail.id} className="flex flex-col rounded-[20px] overflow-hidden border border-card-border bg-card-bg hover:-translate-y-2 hover:border-card-hover-border hover:shadow-[0_20px_40px_rgba(0,0,0,0.4),0_0_20px_rgba(14,165,233,0.05)] group transition-all duration-300">
